...
import 'package:pre_uts/screen_page/page_bottom_navigation.dart';
import 'package:pre_uts/screen_page/page_register_api.dart';
  ...
  Future<ModelLogin?> registerAccount() async {
    try {
      ...
      http.Response response = await http.post(
        Uri.parse('http://192.168.100.110/edukasi_server1/login.php'),
        body: {
